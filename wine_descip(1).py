...
def getVariety_table(variety):
    variety_list = []
    df = readIn('C:/Users/Anthony/Documents/CPSC393/winemag-data_first150k.csv')
...
def results(variety, price, point):
    ...
    scentence2 = listToScentence(writeScentence(first_word_matrix, transition_matrix, unique_firsts, unique_words))

    return (scentence, scentence1, scentence2)
